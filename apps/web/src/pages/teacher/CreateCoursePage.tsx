...
export function CreateCoursePage() {
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    try {
      ...
      toast.error(error.response?.data?.detail || 'Kurs yaratishda xatolik');
    } finally {
      setLoading(false);
    }
  };
    ...
    <div className="py-8 md:py-12">
      <div className="container-custom max-w-4xl">
        ...
        <div className="mb-8">
          ...
          <h1 className="text-2xl md:text-3xl font-bold mb-2">Yangi kurs yaratish</h1>
          <p className="text-slate-400">Yangi kurs ma'lumotlarini kiriting</p>
        </div>
